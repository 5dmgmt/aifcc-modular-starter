...
AIFCCユーザー（スタートアップ創業者・営業担当）が実際に使うシーンを定義：
...
| 要素 | 内容 |
|------|------|
| ロール | AIFCCのAIアシスタント「AIFCCアシスタント」 |
...
```markdown
あなたは AIFCC Cockpit (AIFCC) の AI アシスタント「AIFCCアシスタント」です。
